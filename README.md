...
Opencode-Zen Deepseek-v4-flash-free代餐，主包用的是WSL内的DSH，用DeepSeek-v4-flash-free一直说免费额度用完，但是在Win的Opencode就能用，所以计划做Win端Opencode端的代餐（毕竟是免费的），因为上下文才200k就不用Route-spec预设了，只做了Route-standard，还没测试compact后会不会降智（但最好是控制一下上下文，一般的任务用Route-spec的200K上下文就足够了，毕竟是代餐）
